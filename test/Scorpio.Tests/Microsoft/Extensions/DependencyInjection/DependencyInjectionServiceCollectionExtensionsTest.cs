...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    /// 
    /// </summary>
    public class DependencyInjectionServiceCollectionExtensionsTest
    {
        ...
        public void RegisterAssemblyByConventionOfType()
        {
            ...
            Should.NotThrow(() => services.AddConventionalRegistrar(registrar));
            Should.NotThrow(() => services.RegisterAssemblyByConventionOfType<DependencyInjectionServiceCollectionExtensionsTest>());
        }
