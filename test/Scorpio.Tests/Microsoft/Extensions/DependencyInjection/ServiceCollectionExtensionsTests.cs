...
namespace Microsoft.Extensions.DependencyInjection
{
    public class ServiceCollectionExtensionsTests
    {
        ...
        public void RegisterAssembly_1()
        {
            ...
            services.RegisterConventionalDependencyInject(typeof(ServiceCollectionExtensionsTests).Assembly.GetTypes(), config =>
            {
        ...
        {
            var services = new ServiceCollection();
            services.RegisterConventionalDependencyInject(typeof(ServiceCollectionExtensionsTests).Assembly.GetTypes(), config => config.Where(t => t.Name == nameof(Service1)).AsSelf());
        ...
        {
            var services = new ServiceCollection();
            services.RegisterConventionalDependencyInject(typeof(ServiceCollectionExtensionsTests).Assembly.GetTypes(), config => config.Where(t => t.Name == nameof(Service1)).AsAll().Lifetime(ServiceLifetime.Transient));
            services.ShouldContainTransient(typeof(IService1), typeof(Service1));
        ...
        {
            var services = new ServiceCollection();
            services.RegisterConventionalDependencyInject(typeof(ServiceCollectionExtensionsTests).Assembly.GetTypes(), config => config.Where(t => t.Name == nameof(ExposeService)).AsExposeService());
