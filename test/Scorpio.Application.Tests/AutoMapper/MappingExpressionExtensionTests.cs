...
{
    public class MappingExpressionExtensionTests
    {
        [Fact]
        public void MapFromExtraProperty()
        {
            var mapper = new Mapper(new MapperConfiguration(expression => expression.CreateMap<TestClass, TestClassDto>()
        ...
        {
            var mapper = new Mapper(new MapperConfiguration(expression => expression.CreateMap<TestClassDto, TestClass>()
