...
{
    public class PermissionDefinitionManagerTest : IntegratedTest<AuthorizationTestModule>
    {
        private readonly IPermissionDefinitionManager _permissionDefinitionManager;
        public PermissionDefinitionManagerTest() => _permissionDefinitionManager = ServiceProvider.GetService<IPermissionDefinitionManager>();
