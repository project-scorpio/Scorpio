...
{
    public class SettingDeinitionManagerTests : TestBase.IntegratedTest<SettingTestModule>
    {
        private readonly ISettingDefinitionManager _settingDefinitionManager;


        public SettingDeinitionManagerTests() => _settingDefinitionManager = ServiceProvider.GetService<ISettingDefinitionManager>();
